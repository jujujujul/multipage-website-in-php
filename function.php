...
if ($message_san === "message" || $message_san === "" && $email_valid === "mail" || $email_valid === "") {

    // require("formulaire.php");
    echo "vous devez remplir la zone de message et indiquer votre adresse mail pour pouvoir envoyer votre formulaire";
    ...
    if (isset($_POST['submit'])) {
        ...
        try {
            ...
            $mail->Body    = "Bonjour " . $gender . " " . $prenom_san . ",<br>Votre message est le suivant : <br><br>" . $message_san;
